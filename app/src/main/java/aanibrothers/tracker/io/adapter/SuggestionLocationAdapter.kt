    ...
    override fun onBindViewHolder(holder: DataViewHolder, position: Int) {
        holder.binding.apply {
            if (position == 0 && currentLocation != null) {
                val yourLocationLabel = context.getString(R.string.label_your_location)
                textMapLocationArea.text = yourLocationLabel
                textMapLocationDetails.text = context.getString(
